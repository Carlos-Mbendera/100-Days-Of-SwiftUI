...
struct ContentView: View {
    ...
    var totalCalculatedAmount: Double {
        ...
        let finalPercent = Double(tipPercent) / 100.00
    ...
    var body: some View {
            ...
            NavigationView {
                ...
                header: {
                    ...
                    Section{
                        Text(checkTotal * (Double(tipPercent) / 100.00)  + checkTotal, format: userCurrencyType )
                            .foregroundColor( tipPercent == 0 ? Color.red : Color.primary)
                    }header: {
                        Text("Total Without Dividing With Friends")
                    }
                }
